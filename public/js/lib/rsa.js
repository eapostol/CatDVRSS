...
// Simple RSA Encryption using BigInt Library

function encrypt(s, packedPublicKey)
{
	var keyParts = packedPublicKey.split(":");
	
	// modulues
	var n = str2bigInt(keyParts[0],36,0);
	// exponent
	var e = str2bigInt(keyParts[1],36,0);
